...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="http://localhost:8080/CRM/projectcreate" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										...
										<c:forEach var="project" items="${listProject}">
											<tr>
												...
												<td><a href="http://localhost:8080/CRM/projectupdate?id=<c:out value='${project.id}' />"" class="btn btn-sm btn-primary">Sửa</a>
													<a href="http://localhost:8080/CRM/projectdelete?id=<c:out value='${project.id}' />"" class="btn btn-sm btn-primary">Xóa</a> <a
			...
			<!-- /.container-fluid -->
			<footer class="footer text-center"> 2022 &copy; myclass.com
			</footer>
		</div>
		<!-- /#page-wrapper -->
	</div>
