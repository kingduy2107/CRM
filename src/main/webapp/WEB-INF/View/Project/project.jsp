			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="http://localhost:8080/CRM/projectcreate"
									...
									<tbody>
										...
										<c:forEach var="project" items="${listProject}">
											<tr>
												...
												<td><a
													href="http://localhost:8080/CRM/projectupdate?id=<c:out value='${project.id}' />"
													" class="btn btn-sm btn-primary">Sửa</a> <a
													href="http://localhost:8080/CRM/projectdelete?id=<c:out value='${project.id}' />"
													" class="btn btn-sm btn-primary">Xóa</a> <a
