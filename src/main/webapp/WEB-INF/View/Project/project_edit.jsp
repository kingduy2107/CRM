						...
						<div class="white-box">
							...
							class="form-horizontal form-material">
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="name_project" placeholder="Tên công việc" value="${ project.name_project }"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="description_project" placeholder="Mô tả dự án" value="${ project.description_project }"
											class="form-control form-control-line">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="startdate" placeholder="yyyy-mm-dd" value="${ project.startdate }"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="enddate" placeholder="yyyy-mm-dd" value="${ project.enddate }"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="account_id" placeholder="Người thực hiện" value="${ project.account_id }"
											class="form-control form-control-line">
									</div>
								</div>
