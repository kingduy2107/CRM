			...
			<div class="navbar-header">
				...
				<div class="top-left-part">
					<a class="logo" href="<%=request.getContextPath()%>/home"> <b> <img
							src="<%=request.getContextPath()%>/assets/plugins/images/pixeladmin-logo.png"
							alt="home" />
					</b> <span class="hidden-xs"> <img
							src="<%=request.getContextPath()%>/assets/plugins/images/pixeladmin-text.png"
							alt="home" />
					</span>
					</a>
				</div>
					...
					<li>
						<div class="dropdown">
							<a class="profile-pic dropdown-toggle" data-toggle="dropdown"
								href="#"> <img
								src="<%=request.getContextPath()%>/assets/plugins/images/users/varun.jpg"
								...
								<table class="table">
									...
									<tbody>
										<c:forEach var="roles" items="${listRoles}">
											<tr>
												<td>${roles.getRole_id()}</td>
												<td>${roles.getRole_name()}</td>
